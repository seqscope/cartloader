...
def parse_arguments(_args):
    ...
    cmd_params.add_argument('--boundaries', action='store_true', default=False, help='Add segmented cell boundaries to PMTiles output')
    ...
    inout_params.add_argument('--in-json', type=str, help="Provide a JSON file specifying the paths for cells, boundaries, clusters, and differential expression results.")
