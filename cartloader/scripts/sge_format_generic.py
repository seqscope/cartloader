...
def sge_format_generic(_args):
    ...
    inout_params.add_argument('--out-transcript', type=str, default="transcripts.unsorted.tsv", help='File name of output transcript-indexed SGE file in TSV format. Default: transcripts.unsorted.tsv')
    inout_params.add_argument('--out-minmax', type=str, default="coordinate_minmax.tsv", help='File name of output TSV file for min and max X and Y coordinates. Default: coordinate_minmax.tsv')
    inout_params.add_argument('--out-feature', type=str, default="features.clean.tsv.gz", help='File name of output file collects UMI counts on a per-gene basis. Default: features.clean.tsv.gz')
