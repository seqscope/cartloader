...
def sge_combine_tiles(_args):
    ...
    parser.add_argument('--out-transcript', type=str, default="transcripts.unsorted.tsv.gz", help='File name of the output compressed transcript-indexed SGE file in TSV format (default: transcripts.unsorted.tsv.gz).')
    parser.add_argument('--out-minmax', type=str, default="coordinate_minmax.tsv", help='File name of the output the coordinate minmax TSV file (default: coordinate_minmax.tsv).')
    parser.add_argument('--out-feature', type=str, default="feature.clean.tsv.gz", help='File name of the output compressed UMI count per gene TSV file (default: feature.clean.tsv.gz).')
    parser.add_argument('--out-subset', type=str, default="subset_minmax.tsv", help='File name of the output coordinate minmax and offset TSV file (default: subset_minmax.tsv).')
