...
def parse_arguments(_args):
    ...
    aux_params.add_argument('--tsv-cmap', type=str, default=f"{repo_dir}/assets/default_color_map.tsv", help=f'Location of TSV with color mappings for clusters (default: {repo_dir}/assets/default_color_map.tsv)')
