...
def parse_arguments(_args):
    ...
    aux_params.add_argument('--tsv-cmap', type=str, default=f"{repo_dir}/assets/fixed_color_map_512.tsv", help=f'Location of TSV with color mappings for clusters (default: {repo_dir}/assets/fixed_color_map_512.tsv)')
...
def import_visiumhd_cell(_args):
    ...
    if args.cells and not args.skip_mex_pseudobulk:
        ...
        if not args.skip_mex_pseudobulk:
            ...
            pseudobulk_out = f"{pseudobulk_prefix}.tsv.gz"
