...
def feature_distribution(_args):
    ...
    parser.add_argument('--output', type=str, required=True, help='Path to save the distribution file containing: feature_name, number of tiles containing the feature, and per-tile counts. ')
