...
-   ![Interactive Exploration](../docs/images/starter_vignettes/cosmxsmi.t12_f12_p12_a6.png)
    ...
    [Explore in CartoScope](https://v3o-main.carto-scope.org/dataset?uri=s3%2Fcartostore%2Fdata%2Fbatch%3D2026_02%2Fmouse-brain-test-collection%2Fsubdata_cosmxsmi_halfrun1000s1){ .md-button .md-button--primary .button-tight-small }

    [Download from Zenodo](https://zenodo.org/records/18837714){ .md-button .button-tight-small }
