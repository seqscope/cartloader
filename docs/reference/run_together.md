...
**FICTURE mode:** `--width`, `--n-factor` (de-novo); `--project-models` (projection-only). See [Specifying Inputs → FICTURE mode](./run_together_inputs.md#ficture-mode-de-novo-vs-projection).
